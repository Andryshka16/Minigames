...
let ballX = 130, ballY = 160

let speed = 10

const movePlayers = 1

let w,s,up,down,movingW,movingS,movingUp,movingDown, ballMoving, ballInterval,direction,text, bounced
...
reset.addEventListener("click",  ()=>{resetGame(); score.textContent = "0:0"})
